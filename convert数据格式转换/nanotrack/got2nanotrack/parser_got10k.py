'''
got转nanotrack:从文件夹中的groundtruth生成json文件
'''
...
parser.add_argument('--dir',type=str, default='C:\\Users\\li\\Desktop\\repo\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\homemade', help='your vid data dir')
...
json.dump(got10k, open('C:\\Users\\li\\Desktop\\repo\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\homemade\\homemade.json', 'w'), indent=4, sort_keys=True)
