'''
got转nanotrack:从parset_got10k生成的json文件中导出训练和验证的json
'''
...
got10k = json.load(open('C:\\Users\\li\\Desktop\\repo\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\homemade\\homemade.json', 'r'))
...
json.dump(train, open('C:\\Users\\li\\Desktop\\repo\\SiamTrackers-master\\NanoTrack\\data\\results\\homemade\\crop255\\train.json', 'w'), indent=4, sort_keys=True)
