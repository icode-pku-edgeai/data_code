...
got10k_base_path = 'C:\\Users\\li\\Desktop\\repo\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\homemade'
...
def main(instanc_size=255, num_threads=24):
    # crop_path = '/data2/got10k/crop{:d}'.format(instanc_size)
    crop_path = 'C:\\Users\\li\\Desktop\\repo\\SiamTrackers-master\\NanoTrack\\data\\results\\homemade\\crop{:d}'.format(instanc_size)
